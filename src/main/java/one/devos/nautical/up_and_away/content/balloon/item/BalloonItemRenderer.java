...
public class BalloonItemRenderer implements DynamicItemRenderer {
	...
	public void render(ItemStack stack, ItemDisplayContext mode, PoseStack matrices, MultiBufferSource buffers, int light, int overlay) {
		...
		renderBalloonFromItem(matrices, buffers, stack, light, overlay);
		matrices.popPose();
	}

	public static void renderBalloonFromItem(PoseStack matrices, MultiBufferSource buffers, ItemStack stack, int light, int overlay) {
		...
		EntityModel<AbstractBalloon> model = models.choose(balloonItem.shape);
	...
	public static void renderInflatingBalloon(PoseStack matrices, MultiBufferSource buffers, ItemStack stack, Player player,
		...
		BalloonItemRenderer.renderBalloonFromItem(matrices, buffers, stack, light, OverlayTexture.NO_OVERLAY);
		matrices.popPose();
	}
}
